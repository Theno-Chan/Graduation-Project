...
+ 就业状况 √
  ...
  + 总失业率（占总劳动力的百分比）
    ...
    E:\学习\机器学习\毕设数据集\数据集\API_SL.UEM.TOTL.ZS_DS2_en_csv_v2_3840538.csv
...
+ 传统算法类
  ...
  + 粒子群算法估计SEIRD模...参数的新冠肺炎疫情预测分析
  + 基于改进的SEIR模型对新冠肺炎的疫情预测及防控措施的评估
  + 新冠肺炎疫情预测模型的比较研究
  + 基于指数平滑模型的湖北省新冠肺炎疫情预测分析
